...
namespace Okapia.Domain.ViewModels.Job
{
    public class JobViewModel
    {
        ...
        [Display(Name = "نام مدیر")] public string JobManagerFullname { get; set; }
        ...
        [Display(Name = "گروه شغل")] public string JobCategory { get; set; }
        public int JobCategoryId { get; set; }

        [Display(Name = "استان")] public string JobProvience { get; set; }
        public int JobProvienceId { get; set; }

        [Display(Name = "شهر")] public string JobCity { get; set; }
        public int JobCityId { get; set; }

        [Display(Name = "منطقه")] public string JobDistrict { get; set; }
        public int JobDistrictId { get; set; }

        [Display(Name = "محله")] public string JobNeighborhood { get; set; }
